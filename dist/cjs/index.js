...
`;
const Typography = dt.h1 `
  font-size: 2rem;
  margin-bottom: 1rem;
  color: #333;
`;
const Children = dt.div `
  font-size: 1.5rem;
  color: #666;
`;

const Page = ({ title, children }) => {
    return (jsxRuntimeExports.jsxs(Container, { "data-testid": "page-container", children: [title && jsxRuntimeExports.jsx(Typography, { children: title }), jsxRuntimeExports.jsx(Children, { children: children })] }));
};
